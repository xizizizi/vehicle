  ...
  <div class="sidebar">
    ...
    <div v-if="selectedLocation" class="selected-location">
      <h6 class="selected-title">
        <i class="fas fa-check-circle me-2"></i>已选位置
      </h6>
      <div>
        ...
        <div class="mt-2">
          <span class="poi-type" :class="`${selectedLocation.type}-badge`">
            <i :class="typeIcons[selectedLocation.type]" class="me-1"></i
            >{{ selectedLocation.type }}
          </span>
        </div>
        <div class="mt-2">
          <small
            ><strong>坐标:</strong> {{ selectedLocation.lat.toFixed(6) }},
            {{ selectedLocation.lng.toFixed(6) }}</small
          >
        </div>
      </div>
      ...
      <div>
        ...
        <div class="stat-item">
          ...
          <span class="stat-value"
            ><strong>{{ totalCount }} 个</strong></span
          >
        </div>
      </div>
    </div>
...
const nanchangPOIData = {
  data: {
    ...
    locations: [
      ...
      {
        address: "江西省南昌市东湖区爱国路92号",
        id: 6600513869935474068,
        lat: 28.711791,
        lng: 115.879606,
        name: "江西省人民医院",
        type: "医疗",
      ...
      {
        address: "江西省南昌市青山湖区北京东路",
        id: 6600513869935474069,
        lat: 28.667088,
        lng: 115.842114,
        name: "南昌大学第二附属医院",
        type: "医疗",
      ...
      {
        address: "江西省南昌市红谷滩区红谷中大道",
        id: 6600513869935474070,
        lat: 28.683892,
        lng: 115.899238,
        name: "南昌市洪都中医院",
        type: "医疗",
      ...
      {
        address: "江西省南昌市东湖区阳明路122号",
        id: 6600513869935474071,
        lat: 28.693298,
        lng: 115.9023,
        name: "江西省儿童医院",
        type: "医疗",
      ...
      {
        address: "江西省南昌市红谷滩区西站大街",
        id: 6600513869935474072,
        lat: 28.627024,
        lng: 115.810491,
        name: "江西省妇幼保健院(九龙湖院区)",
        type: "医疗",
      ...
      {
        address: "江西省南昌市西湖区松柏路",
        id: 6600513869935474073,
        lat: 28.629699,
        lng: 115.876291,
        name: "南昌市第一中学",
        type: "教育",
      ...
      {
        address: "江西省南昌市红谷滩区绿茵路",
        id: 6600513869935474074,
        lat: 28.705898,
        lng: 115.859801,
        name: "南昌市第二中学",
        type: "教育",
      ...
      {
        address: "江西省南昌市新建区乐化镇",
        id: 6600513869935474075,
        lat: 28.864072,
        lng: 115.918639,
        name: "昌北机场",
        type: "交通",
      ...
      {
        address: "江西省南昌市青山湖区昌东镇",
        id: 6600513869935474076,
        lat: 28.619678,
        lng: 116.027898,
        name: "南昌东站",
        type: "交通",
      ...
      {
        address: "江西省南昌市红谷滩区赣江中大道",
        id: 6600513869935474077,
        lat: 28.688643,
        lng: 115.869658,
        name: "秋水广场",
        type: "景点",
      ...
      {
        address: "江西省南昌市东湖区民德路",
        id: 6600513869935474078,
        lat: 28.684104,
        lng: 115.903784,
        name: "八一公园",
        type: "景点",
      ...
      {
        address: "江西省南昌市红谷滩区春晖路",
        id: 6600513869935474080,
        lat: 28.706614,
        lng: 115.867836,
        name: "南昌市公安局",
        type: "政府",
...
.filter-btn.education.active {
  background-color: #198754;
}

.filter-btn.commercial {
  background-color: #fff3cd;
  color: #ffc107;
}
.filter-btn.commercial.active {
...
.filter-btn.transport {
  background-color: #e2e3e5;
  color: #6c757d;
}
.filter-btn.transport.active {
