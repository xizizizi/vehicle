...
export function getLocations() {
  return directRequest({
    ...
    .then((response) => {
      ...
      return handleResponse(response, {
        南昌站: { lng: 115.926112, lat: 28.66832 },
        昌北机场: { lng: 115.918639, lat: 28.864072 },
        八一广场: { lng: 115.910978, lat: 28.680175 },
        南昌航空大学: { lng: 115.834196, lat: 28.656103 },
        徐坊客运站: { lng: 115.889, lat: 28.663 },
        南昌西站: { lng: 115.799611, lat: 28.628861 },
        南昌市洪都中医院: { lng: 115.899238, lat: 28.683892 },
      });
    })
    .catch((error) => {
      return handleError(error, {
