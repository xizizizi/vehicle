...
CREATE TABLE `cruise_mission` (
  ...
  `system_type` varchar(20) DEFAULT 'LOGISTICS' COMMENT '系统类型: LOGISTICS(物流), MEDICAL(医疗)',
  `severity_level` varchar(20) DEFAULT NULL COMMENT '严重程度: CRITICAL, HIGH, MEDIUM, NORMAL',
  `hospital_name` varchar(100) DEFAULT NULL COMMENT '医院名称',
  `response_time` int DEFAULT '0' COMMENT '响应时间要求(分钟)',
  `medical_data_id` bigint DEFAULT NULL COMMENT '关联的巡检数据ID',
  PRIMARY KEY (`id`),
  KEY `idx_status` (`status`),
  KEY `idx_assigned_uav` (`assigned_uav_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='巡航任务表';

/*Data for the table `cruise_mission` */

insert  into `cruise_mission`(`id`,`mission_name`,`mission_type`,`status`,`route_points`,`assigned_uav_id`,`priority`,`start_time`,`end_time`,`created_time`,`updated_time`,`deleted`,`system_type`,`severity_level`,`hospital_name`,`response_time`,`medical_data_id`) values 
(1,'南昌交通巡查','CRUISE','ACTIVE','[{\"lat\": 28.662, \"lng\": 115.907, \"name\": \"南昌站\"}, {\"lat\": 28.62, \"lng\": 115.768, \"name\": \"南昌西站\"}, {\"lat\": 28.865, \"lng\": 115.9, \"name\": \"昌北机场\"}]',1,2,'2025-11-10 16:08:43',NULL,'2025-11-10 15:57:23','2025-11-10 15:57:23',0,'LOGISTICS',NULL,NULL,0,NULL),
(2,'机场快线','CRUISE','ACTIVE','[{\"lat\": 28.865, \"lng\": 115.9, \"name\": \"昌北机场\", \"stopTime\": 60}, {\"lat\": 28.679, \"lng\": 115.899, \"name\": \"八一广场\", \"stopTime\": 30}, {\"lat\": 28.662, \"lng\": 115.907, \"name\": \"南昌站\", \"stopTime\": 60}, {\"lat\": 28.865, \"lng\": 115.9, \"name\": \"昌北机场\"}, {\"lat\": 28.662, \"lng\": 115.907, \"name\": \"南昌站\"}]',2,2,'2025-11-10 21:15:41',NULL,'2025-11-10 18:14:09','2025-11-10 18:14:09',0,'LOGISTICS',NULL,NULL,0,NULL),
(3,'机场快线','CRUISE','ACTIVE','[{\"lat\": 28.865, \"lng\": 115.9, \"name\": \"昌北机场\", \"stopTime\": 60}, {\"lat\": 28.679, \"lng\": 115.899, \"name\": \"八一广场\", \"stopTime\": 30}, {\"lat\": 28.662, \"lng\": 115.907, \"name\": \"南昌站\", \"stopTime\": 60}, {\"lat\": 28.6634, \"lng\": 115.8893, \"name\": \"南昌市洪都中医院\"}]',12,2,'2026-01-31 21:28:28',NULL,'2026-01-28 19:16:37','2026-01-28 19:16:37',0,'LOGISTICS',NULL,NULL,0,NULL),
(4,'红谷滩变电站红外测温_巡检_1770094703607','CRUISE','PENDING','[]',NULL,2,NULL,NULL,'2026-02-03 12:59:13','2026-02-03 12:59:13',0,'LOGISTICS',NULL,NULL,0,NULL),
(5,'110kV输电线路树障巡查_巡检_1770114133632','CRUISE','ACTIVE','[{\"lat\": 28.693298, \"lng\": 115.9023, \"name\": \"无人机当前位置\", \"altitude\": 100, \"stopTime\": 0}, {\"lat\": 28.6718, \"lng\": 115.9043, \"name\": \"110kV输电线路树障巡查\", \"altitude\": 100, \"stopTime\": 10}]',30,1,'2026-02-03 18:22:26',NULL,'2026-02-03 18:22:26','2026-02-03 18:22:26',0,'POWER','SEVERE',NULL,10,53),
(6,'森林火险巡查_2024Q2_巡检_1770115411231','CRUISE','ACTIVE','[{\"lat\": 28.693298, \"lng\": 115.9023, \"name\": \"无人机当前位置\", \"altitude\": 200, \"stopTime\": 0}, {\"lat\": 28.6845, \"lng\": 115.8572, \"name\": \"森林火险巡查_2024Q2\", \"altitude\": 200, \"stopTime\": 30}]',31,1,'2026-02-03 18:43:37',NULL,'2026-02-03 18:43:37','2026-02-03 18:43:37',0,'FOREST','ECOLOGY',NULL,30,50);
...
CREATE TABLE `inspection_data` (
  ...
  `system_type` varchar(20) DEFAULT 'INSPECTION' COMMENT '系统类型: INSPECTION(巡查), MEDICAL(医疗), POWER(电力), FOREST(森林)',
  `severity_level` varchar(20) DEFAULT 'NORMAL' COMMENT '严重程度',
  `response_time` int DEFAULT '0' COMMENT '响应时间(分钟)',
  `resolution_time` int DEFAULT '0' COMMENT '解决时间(分钟)',
  `additional_data` json DEFAULT NULL COMMENT '扩展数据(JSON格式)',
  `area_type` varchar(50) DEFAULT NULL COMMENT '区域类型（从 areas 表同步）',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='巡查数据主表（元数据）';

/*Data for the table `inspection_data` */

insert  into `inspection_data`(`id`,`task_name`,`area_id`,`drone_id`,`uploader_id`,`capture_time`,`latitude`,`longitude`,`altitude`,`file_count`,`data_type`,`description`,`status`,`created_at`,`updated_at`,`system_type`,`severity_level`,`response_time`,`resolution_time`,`additional_data`,`area_type`) values 
(1,'桥梁定期巡查_2024Q1',1,'DJI-AIR001',1,'2024-03-15 09:30:00',39.9042,116.4074,150.5,24,'PHOTO','季度桥梁结构安全检查，重点关注桥墩和桥面状况','已审核','2025-10-09 17:25:05','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'BRIDGE'),
(2,'高速公路边坡监测',2,'DJI-MAVIC002',2,'2024-03-18 14:20:00',31.2304,121.4737,80.2,15,'VIDEO','K25+300至K26+100路段边坡稳定性巡查','待审核','2025-10-09 17:25:05','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'BRIDGE'),
(3,'电力线路巡检_220kV',3,'DJI-PHANTOM003',1,'2024-03-20 10:15:00',23.1291,113.2644,200.8,8,'PHOTO','220kV输电线路走廊树障排查','已审核','2025-10-09 17:25:05','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'COMMERCIAL'),
(4,'建筑工地进度记录',1,'DJI-AIR001',3,'2024-03-22 16:45:00',39.9042,116.4074,120,12,'ORTHO','A地块主体结构施工进度正射影像采集','已归档','2025-10-09 17:25:05','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'BRIDGE'),
(5,'河道水质巡查',2,'DJI-MAVIC002',2,'2024-03-25 11:00:00',31.2304,121.4737,60.5,6,'VIDEO','河道排污口巡查及水质异常情况记录','待审核','2025-10-09 17:25:05','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'BRIDGE'),
(6,'矿山三维建模',4,'DJI-MATRICE004',1,'2024-03-28 13:30:00',25.0375,102.7221,350.7,156,'MODEL','采矿区高精度三维模型数据采集','已审核','2025-10-09 17:25:05','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'COMMERCIAL'),
(7,'地形测绘项目',3,'DJI-PHANTOM003',3,'2024-04-01 09:00:00',23.1291,113.2644,180.3,89,'POINTCLOUD','开发区地形测绘点云数据采集','已审核','2025-10-09 17:25:05','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'COMMERCIAL'),
(8,'应急事故勘查',1,'DJI-AIR001',1,'2024-04-03 15:20:00',39.9042,116.4074,95.8,18,'PHOTO','交通事故现场勘查及证据固定','已归档','2025-10-09 17:25:05','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'BRIDGE'),
(9,'农业植保监测',5,'DJI-AGRAS005',2,'2024-04-05 10:45:00',30.2741,120.1551,25.6,32,'OTHER','小麦病虫害无人机监测作业','待审核','2025-10-09 17:25:05','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'RESIDENTIAL'),
(10,'城市绿化调查',2,'DJI-MAVIC002',3,'2024-04-08 14:10:00',31.2304,121.4737,75.2,27,'PHOTO','中心城区绿化覆盖率调查统计','已审核','2025-10-09 17:25:05','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'BRIDGE'),
(11,'城市绿化调查',1,'DJI-MAVIC002',1,NULL,NULL,NULL,NULL,NULL,NULL,'中心城区绿化覆盖率调查统计','PENDING','2025-10-12 15:36:47','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'BRIDGE'),
(12,'城市绿化调查',2,'DJI-MAVIC002',1,NULL,NULL,NULL,NULL,1,NULL,'中心城区绿化覆盖率调查统计','PENDING','2025-10-12 15:43:40','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'BRIDGE'),
(13,'矿山三维建模',1,'DJI-MATRICE004',1,NULL,NULL,NULL,NULL,1,NULL,'采矿区高精度三维模型数据采集','PENDING','2025-10-12 15:47:00','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'BRIDGE'),
(14,'矿山三维建模',1,'DJI-MATRICE004',1,NULL,NULL,NULL,NULL,1,NULL,'采矿区高精度三维模型数据采集','PENDING','2025-10-12 15:51:39','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'BRIDGE'),
(15,'巡航',4,'dIJ202501',1,NULL,NULL,NULL,NULL,1,NULL,'','PENDING','2025-11-20 16:06:09','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'COMMERCIAL'),
(16,'消防安全检查',5,'DIJ_256',1,NULL,NULL,NULL,NULL,1,NULL,'消防安全检查','PENDING','2025-12-21 11:38:13','2026-01-30 11:33:45','INSPECTION','NORMAL',0,0,NULL,'RESIDENTIAL'),
(17,'心脏骤急救助',18,'DJI-MED001',1,'2024-03-15 10:30:00',28.681945,115.892578,150.5,5,'PHOTO','八一广场附近心脏骤停患者急救','EXECUTING','2026-01-30 11:42:11','2026-01-30 11:42:11','MEDICAL','CRITICAL',8,0,'{\"bloodType\": \"O+\", \"patientAge\": 65, \"requiredMedication\": \"肾上腺素\"}','RESIDENTIAL'),
(18,'药品紧急配送',19,'DJI-MED002',1,'2024-03-16 14:20:00',28.679,115.899,80.2,3,'VIDEO','朝阳新城医院紧急药品运输','COMPLETED','2026-01-30 11:42:11','2026-01-30 11:42:11','MEDICAL','HIGH',15,0,'{\"recipient\": \"李女士\", \"medicineType\": \"胰岛素\", \"deliveryStatus\": \"已完成\"}','RESIDENTIAL'),
(19,'输电线路巡检',1,'DJI-POW001',2,'2024-03-17 09:15:00',28.662,115.907,200.8,12,'PHOTO','220kV输电线路走廊树障排查','EXECUTING','2026-01-30 11:42:11','2026-01-30 11:42:11','POWER','MEDIUM',0,0,'{\"issueType\": \"树障\", \"lineLength\": 5.2, \"voltageLevel\": \"220kV\"}','BRIDGE'),
(20,'变电站设备检查',16,'DJI-POW002',2,'2024-03-18 16:45:00',28.6718,115.9043,120,8,'ORTHO','红谷滩CBD变电站设备温度监测','PENDING','2026-01-30 11:42:11','2026-01-30 11:42:11','POWER','NORMAL',30,0,'{\"loadRate\": 85, \"temperature\": 72, \"equipmentType\": \"变压器\"}','COMMERCIAL'),
(21,'林区火情监测',25,'DJI-FOR001',3,'2024-03-19 11:00:00',28.6845,115.8572,350.7,24,'PHOTO','梅岭国家森林公园火险点巡查','EXECUTING','2026-01-30 11:42:11','2026-01-30 11:42:11','FOREST','HIGH',5,0,'{\"humidity\": 45, \"riskLevel\": \"高\", \"windSpeed\": 3.2, \"temperature\": 32}','NATURAL'),
(22,'野生动物监测',23,'DJI-FOR002',3,'2024-03-20 13:30:00',28.6602,115.8129,180.3,15,'VIDEO','艾溪湖湿地公园野生动物活动监测','COMPLETED','2026-01-30 11:42:11','2026-01-30 11:42:11','FOREST','NORMAL',0,0,'{\"animalType\": \"候鸟\", \"population\": 120, \"activityArea\": \"湿地核心区\"}','NATURAL'),
(40,'高危孕妇紧急送药',18,'DJI-159',1,'2024-03-26 08:30:00',28.6819,115.8925,120,0,'OTHER','红谷滩新区36周孕妇突发腹痛，需紧急配送保胎药物','EXECUTING','2026-02-01 11:20:33','2026-02-05 17:31:28','MEDICAL','CRITICAL',8,0,'{\"symptoms\": \"腹痛、见红\", \"patientAge\": 28, \"bloodPressure\": \"150/95\", \"gestationalWeeks\": 36, \"requiredMedication\": \"黄体酮注射液\"}','RESIDENTIAL'),
(41,'儿童哮喘急性发作',19,'DJI-197',2,'2024-03-26 09:15:00',28.679,115.899,95.5,0,'OTHER','朝阳新城8岁儿童哮喘急性发作，急需支气管扩张剂','EXECUTING','2026-02-01 11:20:33','2026-02-03 14:04:53','MEDICAL','HIGH',10,0,'{\"history\": \"哮喘病史3年\", \"symptoms\": \"呼吸困难、喘息\", \"allergies\": \"无\", \"patientAge\": 8, \"requiredMedication\": \"沙丁胺醇气雾剂\"}','RESIDENTIAL'),
(42,'交通事故现场急救',12,'DJI-142',1,'2024-03-26 10:45:00',28.6785,115.9012,85,0,'OTHER','阳明路交通事故，2名伤员需要急救包和止血带','EXECUTING','2026-02-01 11:20:33','2026-02-02 17:47:27','MEDICAL','CRITICAL',5,0,'{\"injuryType\": \"骨折、出血\", \"patientCount\": 2, \"onSiteCondition\": \"意识清醒\", \"requiredSupplies\": \"急救包、止血带、夹板\", \"estimatedBloodLoss\": \"中度\"}','ROAD'),
(43,'心脏病患者紧急用药',20,'DJI-MED-726',2,'2024-03-26 11:20:00',28.6852,115.905,110,0,'OTHER','青山湖区65岁心脏病患者胸痛，急需硝酸甘油','EXECUTING','2026-02-01 11:20:33','2026-02-02 17:20:03','MEDICAL','HIGH',12,0,'{\"symptoms\": \"胸痛、呼吸困难\", \"heartRate\": \"110\", \"patientAge\": 65, \"bloodPressure\": \"160/100\", \"chronicDiseases\": \"冠心病\", \"requiredMedication\": \"硝酸甘油片\"}','RESIDENTIAL'),
(44,'工厂烧伤事故处理',21,'DJI-841',1,'2024-03-26 13:05:00',28.672,115.91,125,0,'OTHER','经济技术开发区工厂烧伤事故，需要烧伤药膏','EXECUTING','2026-02-01 11:20:33','2026-02-02 17:11:41','MEDICAL','MEDIUM',15,0,'{\"burnArea\": \"手臂10%\", \"painLevel\": \"6/10\", \"burnDegree\": \"II度\", \"patientCount\": 1, \"requiredMedication\": \"磺胺嘧啶银乳膏\", \"disinfectionRequired\": \"是\"}','INDUSTRIAL'),
(45,'糖尿病患者低血糖急救',30,'DJI-915',2,'2024-03-26 14:30:00',28.674,115.898,100,0,'OTHER','东湖区糖尿病患者突发低血糖昏迷，需要葡萄糖','EXECUTING','2026-02-01 11:20:33','2026-02-02 17:10:36','MEDICAL','HIGH',8,0,'{\"symptoms\": \"昏迷、冷汗\", \"bloodSugar\": \"2.1mmol/L\", \"patientAge\": 58, \"consciousness\": \"昏迷\", \"chronicDiseases\": \"糖尿病\", \"requiredMedication\": \"50%葡萄糖注射液\"}','RESIDENTIAL'),
(46,'过敏性休克紧急处理',18,'MED-UAV-704',1,'2024-03-26 15:45:00',28.683,115.895,115,0,'OTHER','红谷滩新区患者食物过敏导致休克，急需肾上腺素','EXECUTING','2026-02-01 11:20:33','2026-02-02 15:00:55','MEDICAL','CRITICAL',5,0,'{\"allergen\": \"海鲜\", \"symptoms\": \"呼吸困难、皮疹、血压下降\", \"patientAge\": 32, \"bloodPressure\": \"80/50\", \"oxygenSaturation\": \"88%\", \"requiredMedication\": \"肾上腺素注射液\"}','RESIDENTIAL'),
(47,'老年人跌倒骨折急救',31,'MED-UAV-349',2,'2024-03-26 16:20:00',28.6735,115.8975,90,0,'OTHER','西湖区78岁老人跌倒疑似骨折，需要急救设备','EXECUTING','2026-02-01 11:20:33','2026-02-02 14:59:35','MEDICAL','MEDIUM',18,0,'{\"symptoms\": \"右腿疼痛、无法站立\", \"patientAge\": 78, \"consciousness\": \"清醒\", \"chronicDiseases\": \"骨质疏松\", \"suspectedInjury\": \"股骨骨折\", \"requiredEquipment\": \"颈托、夹板\"}','RESIDENTIAL'),
(48,'产后大出血紧急输血',19,'MED-UAV-735',1,'2024-03-26 17:10:00',28.6775,115.8985,105,0,'OTHER','朝阳新城产妇产后大出血，急需O型血和止血药物','EXECUTING','2026-02-01 11:20:33','2026-02-02 14:39:48','MEDICAL','CRITICAL',6,0,'{\"symptoms\": \"大量出血、血压下降\", \"patientAge\": 29, \"bloodPressure\": \"85/55\", \"requiredBlood\": \"O型\", \"postpartumHours\": 3, \"estimatedBloodLoss\": \"800ml\", \"requiredMedication\": \"缩宫素、氨甲环酸\"}','RESIDENTIAL'),
(49,'犬咬伤紧急处理',32,'MED-UAV-796',2,'2024-03-26 18:05:00',28.6725,115.896,95,0,'OTHER','青云谱区儿童被犬咬伤，需要狂犬疫苗和破伤风疫苗','EXECUTING','2026-02-01 11:20:33','2026-02-02 14:39:57','MEDICAL','MEDIUM',20,0,'{\"symptoms\": \"右手咬伤、出血\", \"animalType\": \"家犬\", \"patientAge\": 7, \"woundCondition\": \"深部咬伤\", \"requiredVaccines\": \"狂犬疫苗、破伤风疫苗\", \"vaccinationHistory\": \"无狂犬疫苗接种史\"}','RESIDENTIAL'),
(50,'森林火险巡查_2024Q2',25,'DJI-966',1,'2024-04-25 14:00:00',NULL,NULL,NULL,0,'PHOTO','春季森林防火重点区域巡查，监测潜在火险点','EXECUTING','2026-02-02 21:37:33','2026-02-03 18:43:37','FOREST','HIGH',15,0,'{\"humidity\": 42, \"riskLevel\": \"中\", \"windSpeed\": 2.8, \"temperature\": 28, \"monitoringPoints\": 8}','NATURAL'),
(51,'松材线虫监测_梅岭',25,NULL,3,'2024-04-26 09:30:00',NULL,NULL,NULL,0,'PHOTO','松林区域病虫害监测，重点排查松材线虫感染迹象','PENDING','2026-02-02 21:37:33','2026-02-02 21:37:33','FOREST','MEDIUM',60,0,'{\"pestType\": \"松材线虫\", \"sampleCount\": 25, \"treeSpecies\": \"马尾松\", \"affectedArea\": \"15公顷\"}','NATURAL'),
(52,'候鸟迁徙监测_艾溪湖',23,NULL,2,'2024-04-27 06:00:00',NULL,NULL,NULL,0,'VIDEO','春季候鸟迁徙高峰期监测，记录鸟类种类和数量','PENDING','2026-02-02 21:37:33','2026-02-02 21:37:33','FOREST','NORMAL',120,0,'{\"method\": \"红外监测\", \"animalType\": \"候鸟\", \"expectedSpecies\": [\"白鹭\", \"夜鹭\", \"斑嘴鸭\"], \"monitoringPeriod\": \"春季\"}','NATURAL'),
(53,'110kV输电线路树障巡查',21,'DJI-606',2,'2024-04-25 10:00:00',NULL,NULL,NULL,0,'VIDEO','110kV线路走廊树障排查，确保线路安全距离','EXECUTING','2026-02-02 21:37:45','2026-02-03 18:22:26','POWER','HIGH',30,0,'{\"issueType\": \"树障\", \"lineLength\": \"8.5km\", \"voltageLevel\": \"110kV\", \"prioritySections\": [\"K3+200-K4+500\"]}','INDUSTRIAL'),
(54,'红谷滩变电站红外测温',16,NULL,1,'2024-04-26 20:00:00',NULL,NULL,NULL,0,'PHOTO','变电站主变、开关等设备红外测温，排查过热隐患','PENDING','2026-02-02 21:37:45','2026-02-02 21:37:45','POWER','MEDIUM',45,0,'{\"loadRate\": 78, \"equipmentType\": \"变压器、断路器\", \"inspectionMethod\": \"红外热成像\", \"temperatureThreshold\": 85}','COMMERCIAL'),
(55,'山区线路覆冰预警监测',25,NULL,3,'2024-04-28 07:00:00',NULL,NULL,NULL,0,'PHOTO','山区电力线路覆冰情况监测，预防冰灾事故','PENDING','2026-02-02 21:37:45','2026-02-02 21:37:45','POWER','CRITICAL',20,0,'{\"altitude\": \"海拔800米以上\", \"lineType\": \"架空线路\", \"riskLevel\": \"高\", \"weatherCondition\": \"低温阴雨\"}','NATURAL'),
(56,'患者食物过敏导致休克，急需肾上腺素',NULL,'',1,NULL,NULL,NULL,NULL,1,NULL,' 红谷滩新区患者食物过敏导致休克，急需肾上腺素','PENDING','2026-02-05 13:46:10','2026-02-05 13:46:10',NULL,NULL,NULL,NULL,NULL,NULL),
(57,'医疗急救 - 心脏骤停 - 红谷滩新区',18,NULL,1,NULL,NULL,NULL,NULL,0,'OTHER','患者状况: 心脏骤停\n地点: 红谷滩新区\n所需药品: 肾上腺素','PENDING','2026-02-05 15:48:15','2026-02-05 15:48:15','MEDICAL','CRITICAL',5,0,'{\"location\": \"红谷滩新区\", \"patientCondition\": \"心脏骤停\", \"requiredMedication\": \"肾上腺素\"}',NULL),
(58,'电力巡检 - 220kV - 输电线路 - 经济技术开发区',21,NULL,1,NULL,NULL,NULL,NULL,0,'OTHER','线路类型: 输电线路\n电压等级: 220kV\n巡检类型: 树障排查\n问题类型: 树障过高\n地点: 经济技术开发区','PENDING','2026-02-05 15:49:11','2026-02-05 15:49:11','POWER','HIGH',30,0,'{\"lineType\": \"输电线路\", \"location\": \"经济技术开发区\", \"issueType\": \"树障过高\", \"voltageLevel\": \"220kV\", \"inspectionType\": \"树障排查\"}',NULL),
(59,'森林火险监测 - 梅岭国家森林公园',25,NULL,1,NULL,NULL,NULL,NULL,0,'PHOTO','监测地点: 梅岭国家森林公园\n风险等级: 高\n当前温度: 32°C\n湿度: 45%','PENDING','2026-02-05 16:07:26','2026-02-05 16:07:26','FOREST','HIGH',15,0,'{\"humidity\": 45, \"location\": \"梅岭国家森林公园\", \"taskType\": \"FIRE_MONITORING\", \"riskLevel\": \"高\", \"temperature\": 32}',NULL),
(60,'电力巡检 - 220kV - 输电线路 - 红谷滩新区',18,NULL,1,NULL,NULL,NULL,NULL,0,'OTHER','线路类型: 输电线路\n电压等级: 220kV\n巡检类型: 常规巡检\n地点: 红谷滩新区','PENDING','2026-02-05 16:09:05','2026-02-05 16:09:05','POWER','CRITICAL',5,0,'{\"lineType\": \"输电线路\", \"location\": \"红谷滩新区\", \"voltageLevel\": \"220kV\", \"inspectionType\": \"常规巡检\"}',NULL),
(61,'医疗急救 - 心脏骤停 - 红谷滩新区',18,NULL,1,NULL,NULL,NULL,NULL,0,'OTHER','患者状况: 心脏骤停\n地点: 红谷滩新区\n所需药品: 肾上腺素','PENDING','2026-02-05 16:10:01','2026-02-05 16:10:01','MEDICAL','CRITICAL',5,0,'{\"location\": \"红谷滩新区\", \"patientCondition\": \"心脏骤停\", \"requiredMedication\": \"肾上腺素\"}',NULL),
(62,'森林病虫害监测 - 松材线虫 - 梅岭国家森林公园',24,NULL,1,NULL,NULL,NULL,NULL,0,'PHOTO','森林病虫害监测 - 松材线虫 - 梅岭国家森林公园','PENDING','2026-02-06 15:58:00','2026-02-06 15:58:00','FOREST','HIGH',60,0,'{\"location\": \"梅岭国家森林公园\", \"pestType\": \"松材线虫\", \"taskType\": \"PEST_MONITORING\", \"treeSpecies\": \"马尾松\", \"affectedArea\": \"10公顷\"}',NULL),
(63,'电力巡检 - 220kV - 输电线路 - 红谷滩新区',17,NULL,1,NULL,NULL,NULL,NULL,0,'OTHER','线路类型: 输电线路\n电压等级: 220kV\n巡检类型: 常规巡检\n问题类型: 输电线路老化\n地点: 红谷滩新区','PENDING','2026-02-06 15:59:14','2026-02-06 15:59:14','POWER','MEDIUM',30,0,'{\"lineType\": \"输电线路\", \"location\": \"红谷滩新区\", \"issueType\": \"输电线路老化\", \"voltageLevel\": \"220kV\", \"inspectionType\": \"常规巡检\"}',NULL),
(64,'医疗急救 - 心脏病 - 红谷滩新区',18,NULL,1,NULL,NULL,NULL,NULL,0,'OTHER','患者状况: 心脏病\n地点: 红谷滩新区\n所需药品: 肾上腺素','PENDING','2026-02-06 16:00:09','2026-02-06 16:00:09','MEDICAL','CRITICAL',5,0,'{\"location\": \"红谷滩新区\", \"patientCondition\": \"心脏病\", \"requiredMedication\": \"肾上腺素\"}',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='巡查媒体文件（照片/视频/点云/模型）';
...
(69,56,'btd89IV6i2_small.jpg','/uploads/2026-02-05/36c03513-d802-47cb-82f7-3b722f4a7186.jpg','image/jpeg',99912,NULL,NULL,NULL,NULL,NULL,NULL,'2026-02-05 13:46:10');
...
insert  into `orders`(`id`,`order_sn`,`status`,`pickup_lng`,`pickup_lat`,`delivery_lng`,`delivery_lat`,`weight`,`assigned_uav_id`,`created_time`,`updated_time`,`deleted`,`system_type`,`severity_level`,`hospital_name`,`medical_data_id`) values 
(1,'EXP_1762762010995','COMPLETED',115.8990000,28.6790000,115.9070000,28.6620000,1.50,5,'2025-11-10 16:06:51','2025-11-10 16:06:51',0,'LOGISTICS',NULL,NULL,NULL),
(2,'EXP_1762780558759','ASSIGNED',115.8890000,28.6630000,115.9070000,28.6620000,1.20,4,'2025-11-10 21:15:59','2025-11-10 21:15:59',0,'LOGISTICS',NULL,NULL,NULL),
(3,'EXP_1762780762444','ASSIGNED',115.9000000,28.8650000,115.9830000,28.6250000,1.00,3,'2025-11-10 21:19:22','2025-11-10 21:19:22',0,'LOGISTICS',NULL,NULL,NULL),
(4,'EXP_1769598978919','ASSIGNED',115.8925780,28.6819450,115.8893000,28.6634000,1.00,10,'2026-01-28 19:16:19','2026-01-28 19:16:19',0,'LOGISTICS',NULL,NULL,NULL),
(5,'EXP_1769598980017','ASSIGNED',115.8925780,28.6819450,115.8893000,28.6634000,1.00,11,'2026-01-28 19:16:20','2026-01-28 19:16:20',0,'LOGISTICS',NULL,NULL,NULL),
(6,'EXP_1769871610063','ASSIGNED',115.8688630,28.5970350,115.8341960,28.6561030,1.00,18,'2026-01-31 23:00:10','2026-01-31 23:00:10',0,'LOGISTICS',NULL,NULL,NULL),
(7,'EXP_1769872308018','ASSIGNED',115.8688630,28.5970350,115.9261120,28.6683200,1.00,21,'2026-01-31 23:11:48','2026-01-31 23:11:48',0,'LOGISTICS',NULL,NULL,NULL),
(8,'EXP_1770008436491','ASSIGNED',115.9109780,28.6801750,115.8104910,28.6270240,1.00,23,'2026-02-02 13:00:36','2026-02-02 13:00:36',0,'MEDICAL','MEDIUM','南昌大学第一附属医院',49),
(9,'EXP_1770010129603','ASSIGNED',115.8688630,28.5970350,115.8104910,28.6270240,1.00,22,'2026-02-02 13:28:50','2026-02-02 13:28:50',0,'LOGISTICS',NULL,NULL,NULL),
(10,'EXP_1770011217771','ASSIGNED',115.8688630,28.5970350,115.8104910,28.6270240,1.00,24,'2026-02-02 13:46:58','2026-02-02 13:46:58',0,'MEDICAL','MEDIUM','南昌大学第一附属医院',49),
(11,'EXP_1770012103500','ASSIGNED',115.8688630,28.5970350,115.8104910,28.6270240,1.00,25,'2026-02-02 14:01:44','2026-02-02 14:01:44',0,'MEDICAL','MEDIUM','南昌大学第一附属医院',49),
(12,'EXP_1770012332976','ASSIGNED',115.8688630,28.5970350,115.8104910,28.6270240,1.00,26,'2026-02-02 14:05:33','2026-02-02 14:05:33',0,'MEDICAL','CRITICAL','南昌大学第一附属医院',48),
(13,'EXP_1770014504239','ASSIGNED',115.8696580,28.6886430,115.8104910,28.6270240,1.00,28,'2026-02-02 14:41:44','2026-02-02 14:41:44',0,'MEDICAL','MEDIUM','南昌大学第一附属医院',47),
(14,'EXP_1770015654490','ASSIGNED',115.9261120,28.6683200,115.8688630,28.5970350,1.00,29,'2026-02-02 15:00:54','2026-02-02 15:00:54',0,'MEDICAL','CRITICAL','南昌大学第一附属医院',46),
(15,'EXP_1770023435880','ASSIGNED',115.9109780,28.6801750,115.8992380,28.6838920,1.10,13,'2026-02-02 17:10:36','2026-02-02 17:10:36',0,'MEDICAL','HIGH','南昌大学第一附属医院',45),
(16,'EXP_1770023500772','ASSIGNED',115.8688630,28.5970350,115.8104910,28.6270240,1.00,27,'2026-02-02 17:11:41','2026-02-02 17:11:41',0,'MEDICAL','MEDIUM','南昌大学第一附属医院',44),
(17,'EXP_1770024003247','ASSIGNED',115.8992380,28.6838920,115.8104910,28.6270240,1.00,19,'2026-02-02 17:20:03','2026-02-02 17:20:03',0,'MEDICAL','HIGH','南昌市洪都中医院',43),
(18,'MED_1770025647111','ASSIGNED',115.8992380,28.6838920,115.8104910,28.6270240,1.00,16,'2026-02-02 17:47:27','2026-02-02 17:47:27',0,'MEDICAL','CRITICAL','南昌市洪都中医院',42),
(19,'MED_1770098693034','ASSIGNED',115.8688630,28.5970350,115.8104910,28.6270240,1.00,15,'2026-02-03 14:04:53','2026-02-03 14:04:53',0,'MEDICAL','HIGH','南昌大学第一附属医院',41),
(20,'MED_1770283887746','ASSIGNED',115.9109780,28.6801750,115.8104910,28.6270240,1.00,32,'2026-02-05 17:31:28','2026-02-05 17:31:28',0,'MEDICAL','CRITICAL','南昌大学第一附属医院',40);
...
CREATE TABLE `system_config` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_system_key` (`system_type`,`config_key`)
...
CREATE TABLE `uav` (
  ...
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='无人机表';
...
(1,'NCUAV_001','DJI_Mavic_3','ON_MISSION',60,115.9070000,28.6620000,5.00,'MISSION_1','2025-11-05 19:48:38','2026-03-02 15:39:01',0),
...
(12,'DJI-224','DJI_M300','ON_MISSION',100,115.9043000,28.6718000,5.00,'MISSION_3','2025-12-21 10:25:45','2025-12-21 10:25:45',0),
(13,'DJI-551','DJI_Mavic_3','ON_MISSION',100,115.8572000,28.6845000,5.00,'ORDER_15','2025-12-22 15:35:19','2025-12-22 15:35:19',0),
(14,'DJI-915','DJI_Mavic_3','ON_MISSION',100,115.8570000,28.6830000,5.00,NULL,'2025-12-22 15:51:29','2025-12-22 15:51:29',0),
(15,'DJI-197','DJI_Mavic_3','ON_MISSION',100,115.8572000,28.6845000,5.00,'ORDER_19','2025-12-25 11:06:48','2025-12-25 11:06:48',0),
(16,'DJI-142','DJI_Mavic_3','ON_MISSION',100,115.8572000,28.6845000,5.00,'ORDER_18','2026-01-26 19:25:58','2026-01-26 19:25:58',0),
(17,'DJI-841','DJI_Mavic_3','ON_MISSION',100,115.8129000,28.6602000,5.00,NULL,'2026-01-28 19:10:54','2026-01-28 19:10:54',0),
(18,'DJI-MED-408','DJI_Mavic_3','ON_MISSION',100,115.8688630,28.5970350,5.00,'ORDER_6','2026-01-31 22:47:10','2026-01-31 22:47:10',0),
(19,'DJI-MED-296','DJI_Mavic_3','ON_MISSION',100,115.8421140,28.6670880,5.00,'ORDER_17','2026-01-31 22:49:31','2026-01-31 22:49:31',0),
(20,'DJI-MED-726','DJI_Mavic_3','ON_MISSION',100,115.8421140,28.6670880,5.00,NULL,'2026-01-31 22:52:35','2026-01-31 22:52:35',0),
(21,'DJI-MED-920','DJI_Mavic_3','ON_MISSION',100,115.8688630,28.5970350,5.00,'ORDER_7','2026-01-31 23:00:10','2026-01-31 23:00:10',0),
(22,'DJI-MED-479','DJI_Mavic_3','ON_MISSION',100,115.8688630,28.5970350,5.00,'ORDER_9','2026-01-31 23:11:48','2026-01-31 23:11:48',0),
(23,'MED-UAV-393','DJI_Mavic_3','ON_MISSION',100,115.9109780,28.6801750,5.00,'ORDER_8','2026-02-02 13:00:36','2026-02-02 13:00:36',0),
(24,'MED-UAV-225','DJI_M300','ON_MISSION',100,115.8688630,28.5970350,5.00,'ORDER_10','2026-02-02 13:28:50','2026-02-02 13:28:50',0),
(25,'MED-UAV-408','DJI_Mavic_3','ON_MISSION',100,115.8688630,28.5970350,4.50,'ORDER_11','2026-02-02 13:46:58','2026-02-02 13:46:58',0),
(26,'MED-UAV-796','DJI_M300','ON_MISSION',100,115.8688630,28.5970350,5.00,'ORDER_12','2026-02-02 14:01:43','2026-02-02 14:01:43',0),
(27,'MED-UAV-735','DJI_Mavic_3','ON_MISSION',100,115.8688630,28.5970350,5.00,'ORDER_16','2026-02-02 14:05:33','2026-02-02 14:05:33',0),
(28,'MED-UAV-349','DJI_Mavic_3','ON_MISSION',100,115.8696580,28.6886430,5.00,'ORDER_13','2026-02-02 14:41:44','2026-02-02 14:41:44',0),
(29,'MED-UAV-704','DJI_Mavic_3','ON_MISSION',80,115.9261120,28.6683200,5.00,'ORDER_14','2026-02-02 15:00:54','2026-02-02 15:00:54',0),
(30,'DJI-606','DJI_M300','ON_MISSION',100,115.9023000,28.6932980,5.00,'MISSION_5','2026-02-03 17:24:30','2026-02-03 18:22:26',0),
(31,'DJI-966','DJI_M300','ON_MISSION',100,115.9023000,28.6932980,5.00,'MISSION_6','2026-02-03 18:43:23','2026-02-03 18:43:37',0),
(32,'DJI-159','DJI_M300','ON_MISSION',100,115.9023000,28.6932980,5.00,'ORDER_20','2026-02-05 17:30:27','2026-02-05 17:30:27',0),
(33,'DJI-202','DJI_Mavic_3','IDLE',100,115.8688630,28.5970350,5.00,NULL,'2026-02-23 16:28:28','2026-02-23 16:28:28',0);
...
/*Table structure for table `forest_data_view` */

DROP TABLE IF EXISTS `forest_data_view`;

/*!50001 DROP VIEW IF EXISTS `forest_data_view` */;
/*!50001 DROP TABLE IF EXISTS `forest_data_view` */;

/*!50001 CREATE TABLE  `forest_data_view`(
 `id` bigint ,
 ...
 `altitude` double ,
 `file_count` int ,
 `data_type` enum('PHOTO','VIDEO','ORTHO','MODEL','POINTCLOUD','OTHER') ,
 `description` text ,
 `status` varchar(20) ,
...
/*Table structure for table `medical_data_view` */

DROP TABLE IF EXISTS `medical_data_view`;

/*!50001 DROP VIEW IF EXISTS `medical_data_view` */;
/*!50001 DROP TABLE IF EXISTS `medical_data_view` */;

/*!50001 CREATE TABLE  `medical_data_view`(
 `id` bigint ,
 `task_name` varchar(200) ,
 `area_id` int ,
 `drone_id` varchar(100) ,
...
/*Table structure for table `power_data_view` */

DROP TABLE IF EXISTS `power_data_view`;

/*!50001 DROP VIEW IF EXISTS `power_data_view` */;
/*!50001 DROP TABLE IF EXISTS `power_data_view` */;

/*!50001 CREATE TABLE  `power_data_view`(
 `id` bigint ,
 `task_name` varchar(200) ,
 `area_id` int ,
 `drone_id` varchar(100) ,
...
/*View structure for view forest_data_view */

/*!50001 DROP TABLE IF EXISTS `forest_data_view` */;
/*!50001 DROP VIEW IF EXISTS `forest_data_view` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `forest_data_view` AS select `inspection_data`.`id` AS `id`,`inspection_data`.`task_name` AS `task_name`,`inspection_data`.`area_id` AS `area_id`,`inspection_data`.`drone_id` AS `drone_id`,`inspection_data`.`uploader_id` AS `uploader_id`,`inspection_data`.`capture_time` AS `capture_time`,`inspection_data`.`latitude` AS `latitude`,`inspection_data`.`longitude` AS `longitude`,`inspection_data`.`altitude` AS `altitude`,`inspection_data`.`file_count` AS `file_count`,`inspection_data`.`data_type` AS `data_type`,`inspection_data`.`description` AS `description`,`inspection_data`.`status` AS `status`,`inspection_data`.`severity_level` AS `severity_level`,`inspection_data`.`response_time` AS `response_time`,`inspection_data`.`created_at` AS `created_at`,`inspection_data`.`updated_at` AS `updated_at`,`inspection_data`.`additional_data` AS `additional_data` from `inspection_data` where (`inspection_data`.`system_type` = 'FOREST') */;

/*View structure for view medical_data_view */

/*!50001 DROP TABLE IF EXISTS `medical_data_view` */;
/*!50001 DROP VIEW IF EXISTS `medical_data_view` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `medical_data_view` AS select `inspection_data`.`id` AS `id`,`inspection_data`.`task_name` AS `task_name`,`inspection_data`.`area_id` AS `area_id`,`inspection_data`.`drone_id` AS `drone_id`,`inspection_data`.`uploader_id` AS `uploader_id`,`inspection_data`.`capture_time` AS `capture_time`,`inspection_data`.`latitude` AS `latitude`,`inspection_data`.`longitude` AS `longitude`,`inspection_data`.`altitude` AS `altitude`,`inspection_data`.`file_count` AS `file_count`,`inspection_data`.`data_type` AS `data_type`,`inspection_data`.`description` AS `description`,`inspection_data`.`status` AS `status`,`inspection_data`.`severity_level` AS `severity_level`,`inspection_data`.`response_time` AS `response_time`,`inspection_data`.`created_at` AS `created_at`,`inspection_data`.`updated_at` AS `updated_at`,`inspection_data`.`additional_data` AS `additional_data` from `inspection_data` where (`inspection_data`.`system_type` = 'MEDICAL') */;

/*View structure for view power_data_view */

/*!50001 DROP TABLE IF EXISTS `power_data_view` */;
/*!50001 DROP VIEW IF EXISTS `power_data_view` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `power_data_view` AS select `inspection_data`.`id` AS `id`,`inspection_data`.`task_name` AS `task_name`,`inspection_data`.`area_id` AS `area_id`,`inspection_data`.`drone_id` AS `drone_id`,`inspection_data`.`uploader_id` AS `uploader_id`,`inspection_data`.`capture_time` AS `capture_time`,`inspection_data`.`latitude` AS `latitude`,`inspection_data`.`longitude` AS `longitude`,`inspection_data`.`altitude` AS `altitude`,`inspection_data`.`file_count` AS `file_count`,`inspection_data`.`data_type` AS `data_type`,`inspection_data`.`description` AS `description`,`inspection_data`.`status` AS `status`,`inspection_data`.`severity_level` AS `severity_level`,`inspection_data`.`response_time` AS `response_time`,`inspection_data`.`created_at` AS `created_at`,`inspection_data`.`updated_at` AS `updated_at`,`inspection_data`.`additional_data` AS `additional_data` from `inspection_data` where (`inspection_data`.`system_type` = 'POWER') */;
